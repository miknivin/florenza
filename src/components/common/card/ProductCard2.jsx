    ...
    <div className="woocomerce__feature-product">
      ...
      <div className="woocomerce__feature-content">
        <div className="woocomerce__feature-category">
          <Link
            className="woocomerce__feature-categorytitle "style={{ color:"black" }}
        ...
        <div className="woocomerce__feature-titlewraper">
          <Link
            href={`/shop/${el._id}`}
            className="woocomerce__feature-producttitle"style={{ color:"black" }}
          >
            {el.name}
          </Link>
        </div>
        <div className="d-flex justify-content-between align-items-center">
          <div>
            <span className="woocomerce__feature-newprice" style={{ color:"black" }}>
              ₹
              {selectedVariant?.discountPrice ||
                selectedVariant?.price ||
                "N/A"}
            </span>
            <span className="woocomerce__feature-oldprice" style={{ color:"red" }}>
              {selectedVariant?.discountPrice
                ? `₹${selectedVariant.price}`
                : ""}
            </span>
